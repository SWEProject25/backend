import { ApiBody, ApiCookieAuth, ApiOperation, ApiResponse, ApiTags, ApiParam } from '@nestjs/swagger';
import { Body, Controller, HttpStatus, Inject, Post, UseGuards, Param, ParseIntPipe } from '@nestjs/common';
...
export class UsersController {
  ...
  async followUser(@Param('id', ParseIntPipe) followingId: number, @CurrentUser() user: AuthenticatedUser) {
