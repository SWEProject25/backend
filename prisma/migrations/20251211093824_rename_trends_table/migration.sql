...
-- CreateIndex
CREATE INDEX "hashtag_trends_trending_score_idx" ON "hashtag_trends"("trending_score");

-- CreateIndex
CREATE INDEX "hashtag_trends_hashtag_id_idx" ON "hashtag_trends"("hashtag_id");
